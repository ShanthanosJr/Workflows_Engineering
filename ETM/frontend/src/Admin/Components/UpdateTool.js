...
const UpdateTool = ({ tool, onSave, onClose }) => {
  ...
  useEffect(() => {
    const formattedDate = tool.purchaseDate
    ...
    setForm({
      ...
      depreciationRate: tool.depreciationRate || 0.1,
      usageHours: tool.usageHours || 0,
      price: tool.price || "",
      image: tool.image || "",
    });
  }, [tool]);
    ...
    <div className="modal show d-block" tabIndex="-1" style={{ background: "rgba(0,0,0,0.5)" }}>
      <div className="modal-dialog modal-dialog-centered modal-lg">
        <form className="modal-content" onSubmit={handleSubmit}>
          <div className="modal-header bg-primary bg-opacity-25">
            <h5 className="modal-title">Update Tool</h5>
